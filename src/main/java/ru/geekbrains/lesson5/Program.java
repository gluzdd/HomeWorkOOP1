...
public class Program {
    ...
    public static void main(String[] args) {
        ...
        view.reservationTable(new Date(), 3, "Артём");
        view.reservationTable(new Date(), 4, "Петруха");
        view.changeReservationTable(1001, new Date(), 2, "Артём");
        view.printChangeReservationTableResult(1001);
    }
